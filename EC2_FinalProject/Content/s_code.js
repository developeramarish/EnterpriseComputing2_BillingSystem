...
Copyright 1997-2014 Omniture, Inc. More info available at
http://www.omniture.com */

/* setting s_account at the page level*/

var s_account=analytics
var s=s_gi(s_account)

/************************** CONFIG SECTION **************************/

/* You may add or alter any code config here. */
/*set charset variable based on domain or account*/
...
else if(acctmatch.indexOf('scotiabankleap')!=-1){s.charSet='ISO-8859-1';}
...
s.linkInternalFilters=analyticsInternalLinks
...
s.formList="" /*comma delimited, populate with form names*/
...
function s_doPlugins(s) {
	...
	if(!s.prop50){
		...
		else if(acctmatch.indexOf('scotiabankleap')!=-1){s.prop50="LR";}
